...
import paymentStyles from "./ElocutionPayments.module.css";
      ...
      render: (text, record) => (
        <Space size="middle">
          <Button
            ...
            type="ghost"
            // href="/ElocutionPaymentRecordsMark"
            onClick={()=>hanldeMarkPayment(record._id)}
          >
            Mark Payments
          </Button>
          <Button
...
export default ElocutionPayments;
